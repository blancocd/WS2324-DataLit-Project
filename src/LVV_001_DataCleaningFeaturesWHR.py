...
def cleaningFeaturesWHR():
    ...
    ladder_df.to_csv('./dat/cleaned/Life_Ladder.csv', index=True)
    gdp_df.to_csv('./dat/cleaned/GDP.csv', index=True)
    social_sup_df.to_csv('./dat/cleaned/Social_Support.csv', index=True)
    corruption_df.to_csv('./dat/cleaned/Corruption.csv', index=True)
    life_choices_df.to_csv('./dat/cleaned/Life_Choices.csv', index=True)
    generosity_df.to_csv('./dat/cleaned/Generosity.csv', index=True) 
